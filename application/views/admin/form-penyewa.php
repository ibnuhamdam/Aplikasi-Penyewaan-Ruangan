...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <?php 
            if($this->session->flashdata('alert')=='update_gagal'){
            echo "<script> alert('Sayang sekali update gagal');</script>";
         }?>
        ...
        <div class="content">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Data Penyewa</strong></div>
                            <?php foreach($data_ke_view as $data):?>
                            <form method="post" action="<?php echo site_url('controller_admin/update_data/'.$data["id"]);?>">
                            <div class="card-body card-block">
                                
                                <div class="row form-group">
                                    <div class="form-group col-6"><label for="nama" class=" form-control-label">Nama</label>
                                        <input type="text" id="nama" name="nama" value="<?php echo $data["nama"];?>" class="form-control" >
                                    </div>
                                    <div class="form-group col-6"><label for="email" class=" form-control-label">Email</label>
                                        <input type="email" id="email" name="email" value="<?php echo $data["email"];?>" class="form-control" >
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-6">
                                        <div class="form-group"><label for="organisasi" class=" form-control-label">Organisasi/kepanitian</label>
                                            <input type="text" id="organisasi" value="<?php echo $data["organisasi"];?>" name="organisasi" class="form-control" >
                                        </div>                                    
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group"><label for="jumlah" class=" form-control-label">Jumlah</label>
                                            <input type="text" id="jumlah" value="<?php echo $data["jumlah"];?>" name="jumlah" class="form-control" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-6">
                                        <div class="form-group"><label for="keperluan" class=" form-control-label">Keperluan</label>
                                            <input type="text" id="keperluan" value="<?php echo $data["keperluan"];?>" name="keperluan" class="form-control" >
                                        </div>                                    
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group"><label for="lama" class=" form-control-label">Lama</label>
                                            <input type="text" id="lama" value="<?php echo $data["Lama"];?>" name="lama" class="form-control" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group"><label for="tanggal" class=" form-control-label">Tanggal</label>
                                    <input type="text" id="tanggal" name="tanggal" value="<?php echo $data["tanggal"];?>" class="form-control" >
                                </div>
